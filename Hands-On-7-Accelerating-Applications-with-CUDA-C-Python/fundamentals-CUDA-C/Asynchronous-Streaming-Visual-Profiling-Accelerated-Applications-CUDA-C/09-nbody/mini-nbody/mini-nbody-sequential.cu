/*
@(#)File:           $mini-nbody-sequential.cu$
@(#)Version:        $Sequential version N-Body Simulation$
@(#)Last changed:   $Date: 20220319 11:13:00 $
@(#)Purpose:        Sequential N-Body Simulation
@(#)Author:         Murilo Boratto - muriloboratto@gmail.com
@(#)Usage:         
 (*) Hotocompile:   nvcc mini-nbody-sequential.cu -o mini-nbody-sequential -Xcompiler -fopenmp
 (*) Hotoexecute:   ./mini-nbody-sequential <size nBodies>
@(#)Comment:  
